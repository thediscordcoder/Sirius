...
module.exports = {
  ...
  run: async (client, bot, message, args, getCosmetic) => {
    ...
    bot.party.setPlaylist(playlist).catch(err => { return error2('An error occured while trying to change the playlist.', message);});
    success3(`Changed the playlist to ${playlist}.`, message);
  }
}
